...
/**
 * The persistence interface for the workflow request service.
 *
 * <p>
 ...
 * @see WorkflowRequestUtil
 * @generated
 */
@ProviderType
public interface WorkflowRequestPersistence extends BasePersistence<WorkflowRequest> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WorkflowRequestUtil} to access the workflow request persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public java.util.List<WorkflowRequest> findByworkflowDefinitionId(
	...
	*/
	public java.util.List<WorkflowRequest> findByworkflowDefinitionId(
		long companyId, long groupId, long workflowDefinitionId,
		boolean isActive, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<WorkflowRequest> orderByComparator);
	...
	*/
	public void cacheResult(java.util.List<WorkflowRequest> workflowRequests);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, WorkflowRequest> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<WorkflowRequest> findAll();
	...
	*/
	public java.util.List<WorkflowRequest> findAll(int start, int end);
