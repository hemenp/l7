...
public interface ItemLocalService extends BaseLocalService, InvokableLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ItemLocalServiceUtil} to access the item local service. Add custom service methods to {@link com.dsi.intranet.eprocurement.service.impl.ItemLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Item getItemByRequestId(long requestId) throws NoSuchItemException;
