...
/**
 * Provides the local service interface for WorkflowReview. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author CIGNEX Technologies
 * @see WorkflowReviewLocalServiceUtil
...
public interface WorkflowReviewLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WorkflowReviewLocalServiceUtil} to access the workflow review local service. Add custom service methods to {@link com.dsi.intranet.eprocurement.service.impl.WorkflowReviewLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public WorkflowReview addWorkflowReview(WorkflowReview workflowReview);
	...
	*/
	public WorkflowReview createWorkflowReview(long workflowReviewId);
	...
	*/
	...
	public WorkflowReview deleteWorkflowReview(WorkflowReview workflowReview);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public WorkflowReview deleteWorkflowReview(long workflowReviewId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WorkflowReview fetchWorkflowReview(long workflowReviewId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WorkflowReview getWorkflowReview(long workflowReviewId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public WorkflowReview updateWorkflowReview(WorkflowReview workflowReview);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WorkflowReview> getAllWFReviews(long companyId, long groupId,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WorkflowReview> getWorkflowReviews(int start, int end);
