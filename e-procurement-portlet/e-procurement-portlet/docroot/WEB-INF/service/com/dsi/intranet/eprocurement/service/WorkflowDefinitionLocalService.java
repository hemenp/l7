...
/**
 * Provides the local service interface for WorkflowDefinition. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author CIGNEX Technologies
 * @see WorkflowDefinitionLocalServiceUtil
...
public interface WorkflowDefinitionLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WorkflowDefinitionLocalServiceUtil} to access the workflow definition local service. Add custom service methods to {@link com.dsi.intranet.eprocurement.service.impl.WorkflowDefinitionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public WorkflowDefinition deleteWorkflowDefinition(
		WorkflowDefinition workflowDefinition);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public WorkflowDefinition deleteWorkflowDefinition(
		long workflowDefinitionId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WorkflowDefinition fetchWorkflowDefinition(long workflowDefinitionId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WorkflowDefinition> getWorkflowDefinitions(int start, int end);
