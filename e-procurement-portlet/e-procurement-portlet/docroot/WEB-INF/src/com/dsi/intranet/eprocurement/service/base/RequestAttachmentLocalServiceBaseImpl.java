...
import com.dsi.intranet.eprocurement.service.RequestAttachmentLocalService;
...
/**
 * Provides the base implementation for the request attachment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dsi.intranet.eprocurement.service.impl.RequestAttachmentLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class RequestAttachmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RequestAttachmentLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.dsi.intranet.eprocurement.service.RequestAttachmentLocalServiceUtil} to access the request attachment local service.
	 */
	...
	public RequestAttachment addRequestAttachment(
		...
		return requestAttachmentPersistence.update(requestAttachment);
	}
	...
	public RequestAttachment createRequestAttachment(long requestAttachmentId) {
		return requestAttachmentPersistence.create(requestAttachmentId);
	}
	...
	public RequestAttachment deleteRequestAttachment(long requestAttachmentId)
		...
		return requestAttachmentPersistence.remove(requestAttachmentId);
	}
	...
	public RequestAttachment deleteRequestAttachment(
		RequestAttachment requestAttachment) {
		return requestAttachmentPersistence.remove(requestAttachment);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(RequestAttachment.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return requestAttachmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return requestAttachmentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public RequestAttachment fetchRequestAttachment(long requestAttachmentId) {
		return requestAttachmentPersistence.fetchByPrimaryKey(requestAttachmentId);
	}
	...
	public RequestAttachment getRequestAttachment(long requestAttachmentId)
		throws PortalException {
		return requestAttachmentPersistence.findByPrimaryKey(requestAttachmentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(requestAttachmentLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(RequestAttachment.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("requestAttachmentId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(requestAttachmentLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(RequestAttachment.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return requestAttachmentLocalService.deleteRequestAttachment((RequestAttachment)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return requestAttachmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<RequestAttachment> getRequestAttachments(int start, int end) {
		return requestAttachmentPersistence.findAll(start, end);
	}
	...
	public int getRequestAttachmentsCount() {
		return requestAttachmentPersistence.countAll();
	}
	 ...
	 */
	public RequestAttachmentLocalService getRequestAttachmentLocalService() {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.dsi.intranet.eprocurement.model.RequestAttachment",
			requestAttachmentLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RequestAttachmentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = requestAttachmentPersistence.getDataSource();
	...
	@BeanReference(type = RequestAttachmentLocalService.class)
	protected RequestAttachmentLocalService requestAttachmentLocalService;
	...
	private RequestAttachmentLocalServiceClpInvoker _clpInvoker = new RequestAttachmentLocalServiceClpInvoker();
}