...
import com.dsi.intranet.eprocurement.service.WorkflowReviewLocalService;
...
/**
 * Provides the base implementation for the workflow review local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dsi.intranet.eprocurement.service.impl.WorkflowReviewLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class WorkflowReviewLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements WorkflowReviewLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.dsi.intranet.eprocurement.service.WorkflowReviewLocalServiceUtil} to access the workflow review local service.
	 */
	...
	public WorkflowReview addWorkflowReview(WorkflowReview workflowReview) {
		...
		return workflowReviewPersistence.update(workflowReview);
	}
	...
	public WorkflowReview createWorkflowReview(long workflowReviewId) {
		return workflowReviewPersistence.create(workflowReviewId);
	}
	...
	public WorkflowReview deleteWorkflowReview(long workflowReviewId)
		...
		return workflowReviewPersistence.remove(workflowReviewId);
	}
	...
	public WorkflowReview deleteWorkflowReview(WorkflowReview workflowReview) {
		return workflowReviewPersistence.remove(workflowReview);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(WorkflowReview.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return workflowReviewPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return workflowReviewPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public WorkflowReview fetchWorkflowReview(long workflowReviewId) {
		return workflowReviewPersistence.fetchByPrimaryKey(workflowReviewId);
	}
	...
	public WorkflowReview getWorkflowReview(long workflowReviewId)
		throws PortalException {
		return workflowReviewPersistence.findByPrimaryKey(workflowReviewId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(workflowReviewLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(WorkflowReview.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("workflowReviewId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(workflowReviewLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(WorkflowReview.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return workflowReviewLocalService.deleteWorkflowReview((WorkflowReview)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return workflowReviewPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<WorkflowReview> getWorkflowReviews(int start, int end) {
		return workflowReviewPersistence.findAll(start, end);
	}
	...
	public int getWorkflowReviewsCount() {
		return workflowReviewPersistence.countAll();
	}
	 ...
	 */
	public WorkflowReviewLocalService getWorkflowReviewLocalService() {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.dsi.intranet.eprocurement.model.WorkflowReview",
			workflowReviewLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return WorkflowReviewLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = workflowReviewPersistence.getDataSource();
	...
	@BeanReference(type = WorkflowReviewLocalService.class)
	protected WorkflowReviewLocalService workflowReviewLocalService;
	...
	private WorkflowReviewLocalServiceClpInvoker _clpInvoker = new WorkflowReviewLocalServiceClpInvoker();
}