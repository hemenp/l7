...
/**
 * <a href="CorporateSupportFormReader.java.html"><b><i>View Source</i></b></a>
 *
 * @project PGC
 * @author Resmy Mathew
 * @Description
 ...
 * ---------------------------------------------------------------------------------
 */
public class CorporateSupportFormReader extends FormReader
{
            ...
            PGCForm form)
    {
        ...
        ResponseReadersFactory.getResponseReader(CorporateSupportReader.class).parseResponsePart(xmlDoc,
                existingFilesByType, form.getCorporateSupport());
    }
