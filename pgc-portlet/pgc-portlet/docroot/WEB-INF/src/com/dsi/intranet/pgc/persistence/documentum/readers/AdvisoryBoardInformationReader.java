...
/**
 * <a href="AdvisoryBoardInformationReader.java.html"><b><i>View Source</i></b></a>
 *
 * @project PGC
 ...
 * ---------------------------------------------------------------------------------
 */
public class AdvisoryBoardInformationReader extends BlockInfoReader
{
    ...
    {
        if (!(objToPopulate instanceof AdvisoryBoardInformation))
        {
            throw new IllegalArgumentException("objToPopulate to AdvisoryBoardInfoReader should be a AdvisoryBoard!");
        }
        if (xmlRespDoc != null)
        {
            AdvisoryBoardInformation infoObj = (AdvisoryBoardInformation) objToPopulate;
