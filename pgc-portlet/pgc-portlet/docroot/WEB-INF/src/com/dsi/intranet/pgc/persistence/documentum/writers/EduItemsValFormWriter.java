...
/**
 * <a href="EduItemsValFormWriter.java"><b><i>View Source</i></b></a>
 *
 * @project PGC
 * @author Resmy Mathew
 * @Description
 ...
 */
public class EduItemsValFormWriter implements IRequestWriter
{
    @Override
    public DocumentumRequest createRequest(PGCForm form)
    {
        DocumentumRequest req = new DocumentumRequest();
        String path = FilePaths.EDUCATIONAL_PATH;
        if (form != null)
        {
            StringBuilder xmlStrBuf = new StringBuilder();

            xmlStrBuf.append(DocumentumConstants.XML_PREFIX).append(
                    DocumentumConstants.XML_FORM_OBJECT_FORMAT.format(new String[] { "Test Educational Items of Value",
                            "dsi_pgc_edu_item", path }));
            ...
            xmlStrPart = RequestWritersFactory.getRequestWriter(EduItemsInformationWriter.class).createRequestPart(
                    form.getEduItemsInfo());
            ...
            Object[] fileContainerBlocks = new Object[] { form.getEduItemsInfo() };
          ...
          //DSI:START::Veera Reddy:: To create out going request xmls
            PGCCommonUtil.createXml("Educational Value",xmlStrBuf.toString());
