...
/**
 * <a href="DisplayExhibitFormReader.java.html"><b><i>View Source</i></b></a>
 *
 * @project PGC
 * @author Resmy Mathew
 * @Description
 ...
 * ---------------------------------------------------------------------------------
 */
public class DisplayExhibitFormReader extends FormReader
{
            ...
            PGCForm form)
    {
        ...
        ResponseReadersFactory.getResponseReader(DisplayExhibitInformationReader.class).parseResponsePart(xmlDoc,
                existingFilesByType, form.getDispExhibitInfo());
    }
