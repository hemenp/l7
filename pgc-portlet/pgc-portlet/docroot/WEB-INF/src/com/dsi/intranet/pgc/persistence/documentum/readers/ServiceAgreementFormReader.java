...
/**
 * <a href="ServiceAgreementFormReader.java.html"><b><i>View Source</i></b></a>
 *
 * @project PGC
 ...
 * ---------------------------------------------------------------------------------
 */
public class ServiceAgreementFormReader extends FormReader
{
            ...
            PGCForm form)
    {
        ...
        ResponseReadersFactory.getResponseReader(ServiceAgreementReader.class).parseResponsePart(xmlDoc,
                existingFilesByType, form.getServiceAgreement());
    }
