...
/**
 * <a href="ServiceAgreementFormWriter.java.htm"><b><i>View Source</i></b></a>
 *
 * @project PGC
 * @author Resmy Mathew
 * @Description
 ...
 */
public class ServiceAgreementFormWriter implements IRequestWriter
{
    @Override
    public DocumentumRequest createRequest(PGCForm form)
    {
        DocumentumRequest req = new DocumentumRequest();
        String path = FilePaths.SERVICEAGREMENT_PATH;
        if (form != null)
        {
            ...
            xmlStrBuf.append(DocumentumConstants.XML_PREFIX).append(
                    DocumentumConstants.XML_FORM_OBJECT_FORMAT.format(new String[] {
                            "Test Service Agreement Customers", "dsi_pgc_serv_agree_cust", path }));
            ...
            xmlStrPart = RequestWritersFactory.getRequestWriter(ServiceAgreementWriter.class).createRequestPart(
                    form.getServiceAgreement());
            ...
            Object[] fileContainerBlocks = new Object[] { form.getServiceAgreement() };
          ...
          //DSI:START::Veera Reddy:: To create out going request xmls
            PGCCommonUtil.createXml("Service Agreement",xmlStrBuf.toString());
