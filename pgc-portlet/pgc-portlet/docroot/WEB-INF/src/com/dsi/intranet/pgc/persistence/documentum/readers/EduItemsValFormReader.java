...
/**
 * <a href="EduItemsValFormReader.java.html"><b><i>View Source</i></b></a>
 *
 * @project PGC
 ...
 * ---------------------------------------------------------------------------------
 */
public class EduItemsValFormReader extends FormReader
{
            ...
            PGCForm form)
    {
        ...
        ResponseReadersFactory.getResponseReader(EduItemsInformationReader.class).parseResponsePart(xmlDoc,
                existingFilesByType, form.getEduItemsInfo());
    }
