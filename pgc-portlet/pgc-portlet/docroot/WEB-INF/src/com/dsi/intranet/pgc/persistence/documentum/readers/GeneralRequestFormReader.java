...
public class GeneralRequestFormReader extends FormReader{
	...
	protected void parseResponseIntoPGCForm(Document xmlDoc,
        ...
        ResponseReadersFactory.getResponseReader(GeneralRequestInformationReader.class).parseResponsePart(xmlDoc,
                existingFilesByType, form.getRequestInfo());
